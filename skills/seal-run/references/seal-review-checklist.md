# SEAL Review Checklist

Shared checklist used by all SEAL critic implementations (Claude agent, Gemini API, or both). This is the single source of truth for phase-specific review checks.
...
**Date:** [YYYY-MM-DD]
**Reviewer:** [Claude (SEAL Critic -- isolated agent) / Gemini 2.5 Pro (SEAL Critic -- external API)]
...
## Constraints (apply to ALL critic implementations)
